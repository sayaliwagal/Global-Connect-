...
const NavBar = () => {
  return (
    <nav className="bg-slate-900 text-white rounded-2xl shadow-lg py-4 px-6  flex flex-col md:flex-row item-center justify-between  gap-6 flex-wrap sticky top-0 z-50 ">
